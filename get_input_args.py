...
def get_input_args():
    ...
    parser.add_argument('--epochs', type = int, default = 1, dest = 'number_epochs', help = 'Number of Epochs in Training Loop')
    ...
    parser.add_argument('--img_path', type = str, default = 'flowers/test/35/image_06984.jpg', dest = 'img_path', help = 'image path')
