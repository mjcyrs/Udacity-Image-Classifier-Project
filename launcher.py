...
def get_input_args():
    ...
    #Predict Arguments
    parser.add_argument('--cpt', type = str, dest = 'checkpoint', default = 'bigcatmodel.pth', help = 'load a checkpoint')
    parser.add_argument('--top_k', type = int, dest = 'top_classes', default = 5, help = 'List of most likely classifications')
    parser.add_argument('--cat_names', type = str, dest = 'category_name',default = 'cat_to_name.json', help = 'Categories to flower names - json file')
