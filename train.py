...
class trainer:
    ...
    def architecture(self, cnn, hidden_layer, gpu, learn_rate):
        model = cnn
        if model == 'vgg16':
    ...
    def train_eval(self, number_epochs):   
        # model.cuda()
    ...
    def save_cpt(self, gpu, hidden_layer, learn_rate, number_epochs, cp_dir):
